...
for illness in illnesses:
    ...
    vectorizer = TfidfVectorizer(min_df=5, max_df = 0.8, sublinear_tf = True, use_idf = True,decode_error = 'ignore', analyzer = "word", lowercase = False)
    ...
    if 'illness_model_' + illness + '.joblib' not in os.listdir(os.getcwd()):
